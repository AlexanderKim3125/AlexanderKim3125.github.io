...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="page">
        ...
        <page status="">
                ...
                <xsl:if test="//page/payment">
                    ...
                    <form id="frmCardInfo" name="frmCardInfo" method="post" action="auth.jsp" onsubmit="return frmCardInfo_onsubmit()">
                        ...
                        <div class="content-title">
                            ...
                            &#160;<xsl:apply-templates select="//page/payment/order/@currency"/> (<i18n:text>OrderID</i18n:text>: <xsl:apply-templates select="//page/payment/order/@id"/>)<br/>
                            <i18n:text>You can not pay more than 3000 som per day</i18n:text>
                        </div>
                        ...
                        <div class="content-left">
                            ...
                            <div class="row">
                                <div class="span2">
                                    ...
                                    <input type="text" name="card_no_bin" id="card_no_bin" maxlength="19" size="20"  class="span1 content-input" value="" autocomplete="off" style="width: 100%"/>

                                    <!--input name="card_no_bin" id="card_no_bin" type="hidden"  maxlength="16"  value="" />
                                    <input name="card_no_bin2" id="card_no_bin2" maxlength="19" size="20"  class="span2 text-upper content-input" value=""   autocomplete="off"/-->
                                </div>
                                <div class="span1">
                        ...
                        <div>
                            <span>
                                <xsl:if test="//page/result/merchant/@retryLink[.!='']">
                                    <xsl:text> </xsl:text>
                                <xsl:if test="not(contains(//page/result/@code, '19')) and //page/result/@code[.!='-21']">
            ...
            <div id="box" class="block2" style="display: none;"   >
                <font size="3"  face="Verdana">  Сәл күте тұрыңыз! Транзакция жүріп жатыр, біраз уақытыңызды алуы мүмкін.
                    Браузердегі "кері қарай" түймесін баспауыңызды сұраймыз!
                </font><br/><br/>

                <font size="3"  face="Verdana">    Производится обработка транзакции. Это может занять некоторое время.
                    Пожалуйста, дождитесь ответа!</font><br/><br/>
                <p> <font size="3"  face="Verdana">   Your request has been accepted for processing.
                    Please, wait, don’t close this window (or click the "back" button) for a final request!</font><br/><br/></p>
         </div>
    ...
    <xsl:template match="/">
        ...
        <html lang="en">
            ...
            <head>
                ...
                <!-- styles -->
                <link href="/killbill/2013/bee.css" rel="stylesheet"/>
                <link href="/killbill/2013/bootstrap-css.css" rel="stylesheet"/>
                <link href="/killbill/2013/bootstrap-response.css" rel="stylesheet"/>
            </head>
            ...
            <script src="/killbill/2013/jquery-1.7.2-ver.js">&#160;</script>
            <script src="/killbill/2013/jq.maskedinput.js">&#160;</script>
            <script>
